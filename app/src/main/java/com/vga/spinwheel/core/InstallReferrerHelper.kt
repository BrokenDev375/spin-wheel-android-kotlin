...
/**
 * Xác định install có phải từ chiến dịch quảng cáo không.
 * Query InstallReferrer 1 lần rồi cache vào [AppStorage] (nguồn cài không đổi).
 * Dùng để gate màn Intro.
 *
 * NGỮ NGHĨA: mọi nhánh lỗi/không xác định → coi là ads (true).
 *  - có `gclid`                          → ads
...
object InstallReferrerHelper {
    ...
    /** Cache in-memory: đọc/kết nối 1 lần cho mỗi tiến trình. */
    @Volatile
